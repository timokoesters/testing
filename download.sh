...
rsync -av --progress --exclude workdir_mnist5 --exclude venv puffin:testing/workdir_mnist_e2e_fft/samples/ workdir_mnist_e2e_fft/samples
...
rsync -av --progress --exclude workdir_mnist5 --exclude venv puffin:testing/workdir_mnist_e2e_fft/checkpoints/ workdir_mnist_e2e_fft/checkpoints
